const countryData = {
    ...
    headsOfState: [
      {
        ...
        name: "Mark Rutte",
        link:
          "https://en.wikipedia.org/wiki/Prime_Minister_of_the_Netherlands#:~:text=The%20Prime%20Minister%20is%20de,Rutte%2C%20in%20office%20since%202010.",
      },
      {
        title: "First Deputy Prime Minister",
        name: "Hugo de Jonge",
        link: "https://en.wikipedia.org/wiki/Hugo_de_Jonge",
      },
      {
        title: "Second Deputy Prime Minister",
        name: "Kajsa Ollongren",
        link: "https://en.wikipedia.org/wiki/Kajsa_Ollongren",
      },
      {
        title: "Third Deputy Prime Minister",
        name: "Carola Schouten",
        link: "https://en.wikipedia.org/wiki/Carola_Schouten",
      },
    ],
    cities: [
      {
        name: "Amsterdam",
        link: "https://www.amsterdam.info/",
      },
      {
        name: "Rotterdam",
        link: "https://en.rotterdam.info/",
      },
      {
        name: "Utrecht",
        link: "https://www.netherlands-tourism.com/utrecht-2/",
      },
      {
        name: "Groningen",
        link: "https://www.visitgroningen.nl/en",
      },
    ],
    landmarks: [
      {
      ...
      },
      {
        ...
        link:
          "https://www.rembrandthuis.nl/ticket-shop/prices-and-information/?lang=en",
      },
      {
        name: "Cube Houses",
        link:
  ...
  ireland: {
    headsOfState: [
      ...
      },
      {
        ...
        name: "Michael Martin",
        link:
          "https://www.nytimes.com/2020/06/27/world/europe/ireland-prime-minister-micheal-martin.html",
      },
      {
    ...
    cities: [
      ...
      {
        name: "Galway",
        link: "https://www.galwaytourism.ie/",
      },
      {
        name: "Cork",
    ...
    landmarks: [
      {
        name: "Rock of Cashel",
        link:
          "https://www.discoverireland.ie/Arts-Culture-Heritage/rock-of-cashel-st-patrick-s-rock/16152",
      },
      {
      ...
      {
        name: "GPO",
        link: "https://www.gpowitnesshistory.ie/",
      },
      {
  ...
  iceland: {
    headsOfState: [
      ...
      {
        name: "parliment with 63 members",
        link: "https://en.wikipedia.org/wiki/Althing",
        title: "The Althing",
      },
      {
        name: "Þorgeir Örlygsson",
        link: "https://www.bloomsbury.com/author/thorgeir-orlygsson",
        title: "Supreme Court President",
      },
    ],
    landmarks: [
      {
        name:
          "Thingvellir National Park - Rugged volcanic national park & lakes",
        link: "https://www.thingvellir.is/en/",
      },
      {
        name: "Gullfoss Falls - Famed, multi-section waterfall",
        link: "https://en.wikipedia.org/wiki/Gullfoss",
      },
      {
        name: "Golden Circle - Aurora, geyser, glacier, and hot spring",
        link:
          "https://www.nordicvisitor.com/blog/driving-golden-circle-how-to-guide/",
      },
      {
        name: "Jökulsárlón - Big glacial lake with icebergs & seals",
    ...
    cities: [
      ...
      {
        name: "Reykjanesbær",
        link: "https://en.wikipedia.org/wiki/Reykjanesb%C3%A6r",
      },
      {
        name: "Akureyri",
      ...
      {
        name: "Garðabær",
        link: "https://en.wikipedia.org/wiki/Gar%C3%B0ab%C3%A6r",
      },
      {
        name: "Mosfellsbær",
